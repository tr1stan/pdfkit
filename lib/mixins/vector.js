...
export default {
  ...
  save() {
    ...
    // TODO: save/restore colorspace and styles so not setting it unnecessarily all the time?
  ...
  /**
   * @param {string} corners - Specify which corners should have a radius applied. Default '1111'. '0000' would mean no corners would have a radius. Order of bits are: top right, bottom right, bottom left and top left.
   */
  roundedRect(x, y, w, h, r, corners) {
    if (r == null) {
      r = 0;
    }
